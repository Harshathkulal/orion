  ...
  const mainFeatures = [
    {
      ...
      description: "Retrieval-Augmented Generation (RAG) for accurate, context-aware responses based on your uploaded documents.",
      gradient: "from-orange-500 to-yellow-500",
    },
    {
      icon: MessageSquare,
      title: "Chat and Image generation",
      description: "Ask questions. get answers, code, in text format and Generate Images from text prompt and download them",
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-mocha-200 max-w-2xl mx-auto">
            Under the hood, we use the Google Gemini AI models to make sure you get the best possible experience.
          </p>
        </div>
